...
def main():
    ...
    for epoch in range(epoches):
        ...
        grads_ldp=generate_grads_with_privacy_ldp(grads, num_selected=166, clip_norm=1/100, epsilon=epsilon)
        grads=grads_ldp
        #3，真实梯度不处理
        # gards=gards
        file_path = os.path.join('./result/', f'gards_ldp1_{epsilon}_1.pkl')  # 文件路径为 result/gards_ldp1_{epsilon}_1.pkl
        # file_path = os.path.join('./result/', f'gards_ldp1_{epsilon}_2.pkl')  
        # file_path = os.path.join('./result/', f'gards_ldp1_{epsilon}_3.pkl')  
        # file_path = os.path.join('./result/', f'gards_ldp1_{epsilon}_4.pkl')  
        ...
        file_path = os.path.join('./result/', f'sp_ldp1_{epsilon}_1.pkl')  # 文件路径为 result/sp_ldp1_{epsilon}_1.pkl
        # file_path = os.path.join('./result/', f'sp_ldp1_{epsilon}_2.pkl')  
        # file_path = os.path.join('./result/', f'sp_ldp1_{epsilon}_3.pkl')  
        # file_path = os.path.join('./result/', f'sp_ldp1_{epsilon}_4.pkl')  
        with open(file_path, 'wb') as f:
